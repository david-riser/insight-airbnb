...
def create_crime_kde(data, bandwidth = 0.1):
...
if __name__ == '__main__':
    ...
    # Clean data
    airbnb_data = utils.clean_airbnb_dataset(airbnb_data)
    redfin_data = utils.clean_redfin_dataset(redfin_data)
    crimes_data = utils.clean_crimes_dataset(crimes_data)

    # Build crime KDE
    kde = create_crime_kde(crimes_data)
